...
export class CreateDatabase1643807654698 implements MigrationInterface {
    name = 'CreateDatabase1643807654698'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "entries" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "date" character varying NOT NULL, "description" character varying NOT NULL, "value" integer NOT NULL, "category_id" integer, CONSTRAINT "PK_23d4e7e9b58d9939f113832915b" PRIMARY KEY ("id"))`);
